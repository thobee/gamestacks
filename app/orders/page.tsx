  ...
  if (error) {
    return (
      <UserDashboardLayout
        ...
        subtitle="Your purchases and receipts"
      >
        <div className="noir-card flex flex-col items-center justify-center py-16 px-8 text-center">
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-semibold text-white bg-gray-900 rounded-lg hover:bg-black transition-colors"
          >
            Try Again
          </button>
        </div>
      ...
      {orders.length === 0 ? (
        <div className="noir-card flex flex-col items-center justify-center py-16 px-8 text-center">
          ...
          <p className="text-xs text-gray-400 mb-5 max-w-xs">
            You haven&apos;t made any purchases yet. Browse our store to get
            started.
          </p>
          <Link
            href="/games"
                ...
                <div className="flex flex-wrap items-center gap-5">
                  ...
                  {order.receipt?.reference && (
                    <div>
                      ...
                      <p className="text-xs font-semibold text-gray-900 mt-0.5 break-all">
                        {order.receipt.reference}
                      </p>
                    </div>
                  )}
